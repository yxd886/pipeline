...
class Activater():
    ...
    def activate_unit(self,path,graph_def):
        ...
        with tf.device("gpu:0"):
            ...
            x0 = graph.get_operation_by_name("import/input/Placeholder/replica_0")
            x1 = graph.get_operation_by_name("import/input_1/Placeholder/replica_0")
            x2 = graph.get_operation_by_name("import/input_2/Placeholder/replica_0")
            x3 = graph.get_operation_by_name("import/input_3/Placeholder/replica_0")
            x4 = graph.get_operation_by_name("import/input_4/Placeholder/replica_0")
            x5 = graph.get_operation_by_name("import/input_5/Placeholder/replica_0")
            x6 = graph.get_operation_by_name("import/input_6/Placeholder/replica_0")
            x7 = graph.get_operation_by_name("import/input_7/Placeholder/replica_0")
            y0 = graph.get_operation_by_name("import/input/Placeholder_1/replica_0")
            y1 = graph.get_operation_by_name("import/input_1/Placeholder_1/replica_0")
            y2 = graph.get_operation_by_name("import/input_2/Placeholder_1/replica_0")
            y3 = graph.get_operation_by_name("import/input_3/Placeholder_1/replica_0")
            y4 = graph.get_operation_by_name("import/input_4/Placeholder_1/replica_0")
            y5 = graph.get_operation_by_name("import/input_5/Placeholder_1/replica_0")
            y6 = graph.get_operation_by_name("import/input_6/Placeholder_1/replica_0")
            y7 = graph.get_operation_by_name("import/input_7/Placeholder_1/replica_0")
